...
figure(2),histogram(Gm,100),grid,title 'Gain Margin';
figure(3),histogram(Pm,100),grid,title 'Phase Margin';
figure(4),histogram(Sm,100),grid,title 'Stability Margin';

figure(5),histogram(delta_lat_mc,100),grid,title 'Delta Lat';
